...
require_once("include/solicituddepago_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.solicituddepago" );
