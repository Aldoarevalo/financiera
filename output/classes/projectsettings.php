...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "financiero_at_192_168_70_218";
		}
		return $connId;
	}
...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("public.usuarios", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "public.contrato" ] = array( "url" => "contrato", "type" => 0 );
	$projectEntitiesReverse[ "contrato" ] = "public.contrato";
	$projectEntities[ "public.documento" ] = array( "url" => "documento", "type" => 0 );
	$projectEntitiesReverse[ "documento" ] = "public.documento";
	$projectEntities[ "public.estado" ] = array( "url" => "estado", "type" => 0 );
	$projectEntitiesReverse[ "estado" ] = "public.estado";
	$projectEntities[ "public.estadodepago" ] = array( "url" => "estadodepago", "type" => 0 );
	$projectEntitiesReverse[ "estadodepago" ] = "public.estadodepago";
	$projectEntities[ "public.llamado" ] = array( "url" => "llamado", "type" => 0 );
	$projectEntitiesReverse[ "llamado" ] = "public.llamado";
	$projectEntities[ "public.modalidad" ] = array( "url" => "modalidad", "type" => 0 );
	$projectEntitiesReverse[ "modalidad" ] = "public.modalidad";
	$projectEntities[ "public.pac" ] = array( "url" => "pac", "type" => 0 );
	$projectEntitiesReverse[ "pac" ] = "public.pac";
	$projectEntities[ "public.solicituddepago" ] = array( "url" => "solicituddepago", "type" => 0 );
	$projectEntitiesReverse[ "solicituddepago" ] = "public.solicituddepago";
	$projectEntities[ "public.tipollamado" ] = array( "url" => "tipollamado", "type" => 0 );
	$projectEntitiesReverse[ "tipollamado" ] = "public.tipollamado";
	$projectEntities[ "public.trabajorealizado" ] = array( "url" => "trabajorealizado", "type" => 0 );
	$projectEntitiesReverse[ "trabajorealizado" ] = "public.trabajorealizado";
	$projectEntities[ "public.usuarios" ] = array( "url" => "usuarios", "type" => 0 );
	$projectEntitiesReverse[ "usuarios" ] = "public.usuarios";
	$projectEntities[ "public.ordendeserviciocabezera" ] = array( "url" => "ordendeserviciocabezera", "type" => 0 );
	$projectEntitiesReverse[ "ordendeserviciocabezera" ] = "public.ordendeserviciocabezera";
	$projectEntities[ "public.ordendeserviciodetalle" ] = array( "url" => "ordendeserviciodetalle", "type" => 0 );
	$projectEntitiesReverse[ "ordendeserviciodetalle" ] = "public.ordendeserviciodetalle";
	$projectEntities[ "public.proveedor" ] = array( "url" => "proveedor", "type" => 0 );
	$projectEntitiesReverse[ "proveedor" ] = "public.proveedor";
	$projectEntities[ "public.bienservicio" ] = array( "url" => "bienservicio", "type" => 0 );
	$projectEntitiesReverse[ "bienservicio" ] = "public.bienservicio";
}
