...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("public.contrato" == $this->chrt_array['tables'][0])
			return true;
		if("public.documento" == $this->chrt_array['tables'][0])
			return true;
		if("public.estado" == $this->chrt_array['tables'][0])
			return true;
		if("public.estadodepago" == $this->chrt_array['tables'][0])
			return true;
		if("public.llamado" == $this->chrt_array['tables'][0])
			return true;
		if("public.modalidad" == $this->chrt_array['tables'][0])
			return true;
		if("public.pac" == $this->chrt_array['tables'][0])
			return true;
		if("public.solicituddepago" == $this->chrt_array['tables'][0])
			return true;
		if("public.tipollamado" == $this->chrt_array['tables'][0])
			return true;
		if("public.trabajorealizado" == $this->chrt_array['tables'][0])
			return true;
		if("public.usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("public.ordendeserviciocabezera" == $this->chrt_array['tables'][0])
			return true;
		if("public.ordendeserviciodetalle" == $this->chrt_array['tables'][0])
			return true;
		if("public.proveedor" == $this->chrt_array['tables'][0])
			return true;
		if("public.bienservicio" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
