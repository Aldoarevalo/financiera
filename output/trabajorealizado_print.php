...
require_once("include/trabajorealizado_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.trabajorealizado" );
