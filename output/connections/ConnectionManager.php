...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 4;
		$data["connId"] = "financiero_at_192_168_70_218";
		$data["connName"] = "financiero at 192.168.70.218";
		$data["connStringType"] = "postgre";
		$data["connectionString"] = "postgre;192.168.70.218;postgres;jZMrrvb59Sb7kbJa;;financiero;;1;"; //currently unused

		$this->_connectionsIdByName["financiero at 192.168.70.218"] = "financiero_at_192_168_70_218";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "postgres";
		$data["ODBCPWD"] = "jZMrrvb59Sb7kbJa";
		$data["leftWrap"] = "\"";
		$data["rightWrap"] = "\"";
		...
		$data["connInfo"][0] = "192.168.70.218";
		$data["connInfo"][1] = "postgres";
		$data["connInfo"][2] = "jZMrrvb59Sb7kbJa";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "financiero";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "Driver={PostgreSQL Unicode};Server=192.168.70.218;Database=financiero;Uid=postgres;Pwd=jZMrrvb59Sb7kbJa;";
		// encription set
		...
		$connectionsData["financiero_at_192_168_70_218"] = $data;
