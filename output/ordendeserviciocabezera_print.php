...
require_once("include/ordendeserviciocabezera_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.ordendeserviciocabezera" );
