...
function checkTableName($shortTName )
{
	...
	if ("contrato" == $shortTName )
		return true;
	if ("documento" == $shortTName )
		return true;
	if ("estado" == $shortTName )
		return true;
	if ("estadodepago" == $shortTName )
		return true;
	if ("llamado" == $shortTName )
		return true;
	if ("modalidad" == $shortTName )
		return true;
	if ("pac" == $shortTName )
		return true;
	if ("solicituddepago" == $shortTName )
		return true;
	if ("tipollamado" == $shortTName )
		return true;
	if ("trabajorealizado" == $shortTName )
		return true;
	if ("usuarios" == $shortTName )
		return true;
	if ("ordendeserviciocabezera" == $shortTName )
		return true;
	if ("ordendeserviciodetalle" == $shortTName )
		return true;
	if ("proveedor" == $shortTName )
		return true;
	if ("bienservicio" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.contrato");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.documento");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.documento";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.estado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.estadodepago");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.estadodepago";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.llamado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.modalidad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.modalidad";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.pac");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.solicituddepago");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.solicituddepago";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.tipollamado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.tipollamado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.trabajorealizado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.trabajorealizado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.ordendeserviciocabezera");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.ordendeserviciocabezera";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.ordendeserviciodetalle");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.ordendeserviciodetalle";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.proveedor");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.proveedor";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.bienservicio");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.bienservicio";
	}
	return $arr;
}
...
//	default permissions
	...
	if( $table=="public.solicituddepago" )
	{
		if( $sUserGroup=="" )
		{
						return "AEDSPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="public.trabajorealizado" )
	{
		if( $sUserGroup=="" )
		{
						return "AEDSPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="public.ordendeserviciocabezera" )
	{
		if( $sUserGroup=="" )
		{
						return "ADESPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="public.ordendeserviciodetalle" )
	{
		if( $sUserGroup=="" )
		{
						return "ADESPI".$extraPerm;
